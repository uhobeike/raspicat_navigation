...
# Rviz 
xvfb-run --listen-tcp -n 44 --auth-file /tmp/xvfb.auth -s "-ac -screen 0 1920x1080x24" rosrun rviz rviz -d $(find raspicat_navigation)/config/rviz/raspicat_navigation.rviz --fullscreen &
export DISPLAY=:44
